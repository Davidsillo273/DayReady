...
export default function InviteEmployee() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${BASE_URL}/auth/users/employees`, {
        method: 'POST',
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-orange-50 to-white p-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <h1 className="text-center text-xl font-bold text-gray-800 mb-1">Invitar Empleado</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-1">
            <InputField
              ...
              type="email"
              name="email"
              placeholder="employee@dayready.com"
